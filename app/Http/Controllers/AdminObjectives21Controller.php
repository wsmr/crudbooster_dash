<?php namespace App\Http\Controllers;
	...
	class AdminObjectives21Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Countries Id","name"=>"countries_id","join"=>"countries,name"];
			$this->col[] = ["label"=>"Owners Id","name"=>"owners_id","join"=>"owners,name"];
			...
			$this->form[] = ['label'=>'Owners Id','name'=>'owners_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'owners,name'];
			...
			$this->form[] = ['label'=>'Target Timeline','name'=>'target_timeline','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
